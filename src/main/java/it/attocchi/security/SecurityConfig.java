...
import it.attocchi.views.LoginView;
...
//            auth.requestMatchers(HttpMethod.GET, "/line-awesome/**/*.svg").permitAll();
            auth.requestMatchers(HttpMethod.GET, "/line-awesome/**").permitAll();
        });
